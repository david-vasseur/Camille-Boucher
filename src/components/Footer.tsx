		...
		<div className="my-20 flex flex-col gap-4 p-4">
			...
			<div className="flex justify-between">
				<div className="flex flex-col gap-2 md:flex-row md:gap-4 md:underline">
					<Link href="/politique-de-confidentialite" className=" font-oldStandard">Politique de confidentialité</Link>
					<Link href="/mentions-legales" className=" font-oldStandard">Mentions légales</Link>
				</div>
			...
			<nav className="flex flex-col gap-3 md:flex-row md:justify-evenly md:mt-10 md:underline">
				...
				<Link className="ml-5 font-oldStandard" href="/mon-histoire">Qui suis je?</Link>
				<Link className="ml-5 font-oldStandard" href="/eft">EFT</Link>
				<Link className="ml-5 font-oldStandard" href="/soin-energetique">Soin energetique</Link>
				<Link className="ml-5 font-oldStandard" href="/massage-holistique">Massage holistique</Link>
				<Link className="ml-5 font-oldStandard" href="/fleurs-de-bach">Fleurs de bach</Link>
			</nav>
