    ...
    return (
        <div>
            ...
            <section className="mb-10 mt-5">
                ...
                <p className="p-4 text-justify font-semibold">&quote;Il est important de noter que les fleurs de Bach, tout comme toute autre forme de médecine douce, ne remplacent en aucun cas l&apos;avis ou le traitement d&apos;un professionnel de santé qualifié. Pour toute condition médicale, il est essentiel de consulter un médecin.&quote;</p>
            </section>
