...
function Page() {
  return (
    <div className="mt-20 mx-[10%] lg:flex lg:flex-col">
      ...
      <main className="w-[70vw] mx-w-[1920px]">
        <h3 className=" font-parisienne w-[80vw] mx-auto mt-4 text-center mb-2 text-[1.4rem] lg:text-[2.5rem]">&quot; Le véritable bien être réside dans l&apos;équilibre entre le corps, l&apos;esprit et l&apos;ame... &quot;</h3>
        <div className="mt-10">
      ...
      <div className="float-left w-[50vw] lg:w-auto ml-8 mr-4 mt-12 mb-0">
        <Image
      ...
      <div className="float-right w-[55vw] lg:w-auto ml-4 mr-8 mt-12 mb-0">
        <Image
      ...
      <p className="old-standard-tt-regular text-justify p-8 pb-2 mt-4 lg:mt-24">
      ...
      <div className="float-left w-[40vw] lg:w-auto ml-8 mr-4 mt-12 mb-0">
        <Image
      ...
      <p className="old-standard-tt-regular text-justify p-8 pb-2 mt-4 lg:mt-60">
